...
abstract class TeamManagementRepository {
  ...
  Future<void> addMember({required String teamId, required TeamMember member});
...
class InMemoryTeamManagementRepository implements TeamManagementRepository {
  ...
  final List<TeamManagement> _teams = List<TeamManagement>.of(<TeamManagement>[
    TeamManagement(
      id: 'team_1',
  ...
  Future<void> addMember({
    ...
    final updatedMembers = <TeamMember>[...team.members, member];
  ...
  Future<void> setLeader({
    ...
    final updatedMembers = <TeamMember>[
      for (final m in team.members)
        if (m.id == memberId)
          m.copyWith(isLeader: true)
        else
          m.copyWith(isLeader: false),
    ];
  ...
  Future<void> removeMember({
    ...
    final updatedMembers = <TeamMember>[...team.members]
...
final teamManagementRepositoryProvider = Provider<TeamManagementRepository>((
  ref,
) {
